...
unsigned int level2_data[] = {
	...
	3, 1, 1, 1, 0, 0, 1, 1, 1, 2, 2, 2, 2, 2, 3,
	3, 2, 2, 2, 0, 0, 2, 2, 2, 2, 2, 2, 2, 2, 3
};
...
void Level2::Initialize() {
	...
	state.background->textureID = Util::LoadTexture("Sunset Background.png");
	...
	state.enemies[2].position = glm::vec3(10.5f, -2.0f, 0);
	state.enemies[2].enemyType = WALKER;
...
void Level2::Update(float deltaTime) {
	...
	if (state.player->position.y <= -8.0f) {//Handle drops here
		state.player->hp--; 
